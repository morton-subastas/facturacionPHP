    ...
    <div class="container">
      <div class="col-md-12">
        <div class="well well-sm">
          <fieldset>
            <legend class="text-center header"><h1><strong style="color:#004D43 !important">Envío correo confirmación de oferta</strong></h1><br><br></legend>
                <form  class="col-lg-12"  action="searchOffers" method="post" >

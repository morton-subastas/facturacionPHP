...
$conn = new mysqli("localhost", "root", "h0rKm8dEwHZz", "timbrado");
  ...
  if ($conn->connect_error) {
    ...
    if ($trae == 0){
      ...
      VALUES (0,'".$SUB_R."','".$CON_R."','".$PAR_R."','".$PAL_R."','0.00','".$EMA_R."','', 'DEVOLVER','Athos175','".$fac."');";
      //echo $query;
      //$resultado = $query;
      ...
      //$resultado = "UPDATE";
      $query = "UPDATE `emailenviados` SET `lugar30` =  'Athos175' WHERE `contrato` = '".$CON_R."' AND `paleta` ='".$PAL_R."';";
      //echo $query;
      //$resultado = $query;
      $result = $conn->query($query);

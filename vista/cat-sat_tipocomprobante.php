              ...
              <fieldset>
                <nav aria-label="breadcrumb">
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Tipo Comprobante</li>
                  </ol>
                </nav>
              </fieldset>
                <form class="form-horizontal" method="post">
                    <fieldset>
                        <legend class="text-center header"><h1><strong style="color:#004D43 !important">Catálogo S.A.T.</strong> - <strong>Tipo Comprobante</strong></h1></legend>
                        <br>
                        <br>
                        <div class="box-body">
                        <table id="table" class="table table-bordered table-hover table-striped dt-responsive tabla-fac">
                            ...
                            <tbody>
                                ...
                                foreach ($c_TipoComprobante as $key => $value){
                                    echo "<tr>";
                                        echo "<td>".$value['tcomprobante_clave']."</td>";
                                        echo "<td>".$value['tcomprobante_concepto']."</td>";

	...
	if (($fac != '')) {
		...
		try {
			...
			//echo "Cuantos".$cuantos_correos."<br>";
			//$cuantos = 73; //73

			//echo "1)*".$_POST['inicio']."<br>";
			//echo "2)*".$_POST['fin']."<br>";

			//echo "Sub-".$cuantos."-<br>";
			$cuantos = 2;
			//echo "prueba".$cuantos."<br>";
			//for ($i=0; $i <= $cuantos; $i++) {
			for ($i = $_POST['inicio']; $i <= $_POST['fin']; $i++) {
				...
				// $mail->addCC('mbartolo@mortonsubastas.com', 'Morton Subastas');
				$mail->addBCC($fac, 'Morton Subastas');


				//Content
				$mail->isHTML(true);                                  //Set email format to HTML
				$mail->Subject = 'RESULTADO DE SUBASTA ' . $sub . '';
				...
				if (trim($corr) != '') {
					...
					if (($fac == "cpascual@mortonsubastas.com") or ($fac == "jjuarez@mortonsubastas.com") or ($fac == "ebonilla@mortonsubastas.com")) {
						//$o = $i;
						//$correo_envia = $correos_prueba[$o];
						//echo "<br><h2>".$correo_envia."</h2><br>";

						// $mail->addAddress("mbartolo@mortonsubastas.com", "");
						$correo_envia = 'mbartolo@mortonsubastas.com';
						$mail->addAddress($correo_envia, $nombre2);

						//$correo_envia_2 = $variable[$i]['email'];
						//echo "<br><h2>".$correo_envia_2."</h2><br>";
						...
						//$o = $i;
						//$correo_envia = $correos_prueba[$o];
						//unset($mail->addAddress());
						$nombre2 = $variable[$i]["firstname"] . " " . $variable[$i]["lastname"];
						$mail->addAddress($correo_envia, $nombre2);
						//$correo_envia_2 = 'msanchez@mortonsubastas.com';
						//$mail->addBCC($correo_envia_2, 'CORREO');
						//echo "<br><h2>PRUEBA".$correo_envia."</h2><br>";
					}
				}
				// if ($i == 1 || $i == 2) {
				// AQUI ANTES DE LA TABLA
				if (trim($corr) != "" || trim($corr) != null) {
					$bandera = 1;
					$unico = 0;
					$untexto = 0;
					$estimado = 0;
					...
					for ($j = 0; $j <= $cuantos2; $j++) {
						...
						if (($corr == $corr2) and ($con1 == $con2)) {
							if ($estimado == 0) {
								$no_vendio_nada = true;
								//CM0018
								//var_dump($variable2[$j]);
								$nombre = $variable2[$j]["firstname"] . " " . $variable2[$j]["lastname"];
								$body .= "<font face='Helvetica, serif'>" . $nombre . "<br>Presente:<br><p style='text-align:justify'><br>";
								echo  "<font face='Helvetica, serif'>" . $nombre . "<br>Presente:<br><p style='text-align:justify'><br>";
								$body .= "Correo es: <a href='mailto:" . $corr . "'>" . $corr . "</a><br> ";
								echo "Correo es: <a href='mailto:" . $corr . "'>" . $corr . "</a><br> ";

								//echo "-".$fac."-";
								if (($fac == "cpascual@mortonsubastas.com") or ($fac == "jjuarez@mortonsubastas.com") or ($fac == "ebonilla@mortonsubastas.com")) {
									// echo  "<br><h2>".$variable[$i]["email"]."</h2><br>";
									//echo "<br><h2>".$corr."</h2><br>";
									//echo "<br><h2>".$corr2."</h2><br>";
									// $body .= "<br><h2>".$variable[$i]["email"]."</h2><br>";

								}
								$body .= "A continuación le informamos los resultados de la <b> $nom_sub </b> No.<b> $sub. </b>";
								echo "A continuación le informamos los resultados de la <b> $nom_sub </b> No. <b>$sub. </b>";
								$estimado = 1;
							}

							//echo "<br><strong>Posiciónnn:".$j."</strong><br>";
							//echo "price*".$variable2[$j]["price"]."*<br>";
							//var_dump($variable2[$j]);
							if ((trim($variable2[$j]["price"]) == 0) && ($unico == 0) && (trim($variable2[$j]["price"]) != '')) {
								$bandera = 1;
								$unico = 1;
								echo "</table><br><br>
													<p style='text-align:justify'><strong>LOTES NO VENDIDOS</strong></strong><br><br>";
								//echo "Algunos lotes podrán recontratarse para próximas subastas. Favor de esperar el correo electrónico en el cual le haremos saber.<br><br>";
									...
									case 	'ebonilla@mortonsubastas.com':
										if (strpos($nom_sub, "Arte Moderno") > 0 || strpos($nom_sub, "arte moderno") > 0 || strpos($nom_sub, "Arte Mexicano") > 0) {
											...
											echo "
															...
															aqui Usted cuenta con 4 días hábiles posteriores a la subasta para recoger su(s) lote(s) en nuestra sucursal de Cerro de Mayka # 115, Lomas de Chapultepec, el 5to día no hay entrega, los lotes serán trasladados a nuestra bodega ubicada en Av. Constituyentes #910, Lomas Altas y los podrá recoger a partir del 6to día, en un horario de lunes a viernes de 9:30 am a 6:00 pm. De no recogerlos dentro
															de este plazo, Morton Subastas podrá reprogramar su venta automáticamente en otra subasta ajustando el precio a nuestra consideración de acuerdo al contrato de consignación que usted firmó.
															";
											echo "En caso de que usted desee que sus lotes sean recontratados, le sugerimos ponerse en contacto
															con Diana Álvarez al <a href='tel:+525552833140' style='font-weight: bold; color: #004d43; text-decoration: none'>55 52 83 31 40</a> ext. 3145 o vía correo electrónico
															a <a href='mailto:dalvarez@mortonsubastas.com' style='font-weight: bold; color: #004d43; text-decoration: none'>dalvarez@mortonsubastas.com</a>.
															<br>
															<p><b>¿NECESITA ENVIAR A UN REPRESENTANTE POR LA DEVOLUCIÓN?</b>
															<br>
															Debe presentar la siguiente documentación:
															</p>
															<ul>
															<li>Carta poder por medio de la cual autorice a un tercero a recoger los lotes. En dicha carta se
															deberán identificar los lotes que estamos entregando (si desea le podemos enviar un machote
															de la misma).</li>
															<li>Copia de la identificación del consignante / comprador adjunta a la carta poder.</li>
															<li>Copia de la Identificación de la persona autorizada para recoger los lotes.</li>
															</ul>
															<p><b>SI TIENE ALGÚN ADEUDO LAS FORMAS DE PAGO SON LAS SIGUIENTES:</b>
															<br>
															<ol>
															<li>En efectivo (monto máximo $308,866.20 MN) - directamente en nuestras cajas.</li>
															<li>Cheque - salvo buen cobro a nombre de Morton Subasta S.A. de C.V.</li>
															<li>Paypal - Usar como referencia el correo <a href='mailto:creditoycobranza@mortonsubastas.com' style='font-weight: bold; color: #004d43; text-decoration: none'>creditoycobranza@mortonsubastas.com</a> para generar link de pago.</li>
															<li>Tarjeta de crédito y débito - con cargo del 6.6% por uso de tarjeta, directamente en nuestras cajas.</li>
															<li>Transferencia bancaria o depósito en ventanilla o “practicaja”:</li>
															</ol>
															<p>
																<b>
																BBVA Bancomer <br>
																...
																<a href='mailto:creditoycobranza@mortonsubastas.com' style='font-weight: bold; color: #004d43; text-decoration: none'>creditoycobranza@mortonsubastas.com</a>.
																<br>
																Quedamos atentos en caso de que tenga cualquier duda o comentario.
																<br>
																Saludos cordiales.
															</p>
										...
										// echo "En caso de que usted no desee que sus lotes sean recontratados o ya no califiquen para participar en subastas futuras, le sugerimos ponerse en contacto con Fernanda Serrano  al <a href='tel:+525552833140' style='font-weight: bold; color: #004d43; text-decoration: none'>55 52 83 31 40</a> ext. 6894 o vía correo electrónico a <a href='mailto:mserrano@mortonsubastas.com' style='font-weight: bold; color: #004d43; text-decoration: none'>mserrano@mortonsubastas.com</a> ";
										// echo "o con Ana Paula López al <a href='tel:+525552833140' style='font-weight: bold; color: #004d43; text-decoration: none'>55 52 83 31 40 </a>ext. 3384 o vía correo electrónico a <a href='mailto:aplopez@mortonsubastas.com' style='font-weight: bold; color: #004d43; text-decoration: none'>aplopez@mortonsubastas.com</a>.";
										// echo " Para las piezas de Obra Gráfica contactar a Diana Álvarez, al <a href='tel:+525552833140' style='font-weight: bold; color: #004d43; text-decoration: none'>55 52 83 31 40 </a>ext. 3145 o vía correo electrónico a <a href='mailto:dalvarez@mortonsubastas.com' style='font-weight: bold; color: #004d43; text-decoration: none'>dalvarez@mortonsubastas.com</a>";
										break;
									case 'jjuarez@mortonsubastas.com':
										if (strpos($nom_sub, "Antigüedades") > 0 || strpos($nom_sub, "antigüedades") > 0) {
											echo "Algunos lotes podrán recontratarse para próximas subastas. Favor de esperar el correo electrónico en el cual le haremos saber.";
                    ...
                    saber.";
											...
											if ((strpos($nom_sub, "Joyeria") > 0) || (strpos($nom_sub, "Joyería") > 0)) {
											} else {
										...
										//echo "En caso de que usted no desee que sus lotes sean recontratados o ya no califiquen para participar en subastas futuras, le sugerimos ponerse en contacto con Jaciel López al <a href='tel:+525552833140' style='font-weight: bold; color: #004d43; text-decoration: none'> 55 52 83 31 40</a> ext. 5120 o vía correo electrónico a <a href='mailto:mramirez@mortonsubastas.com' style='font-weight: bold; color: #004d43; text-decoration: none'>jlopez@mortonsubastas.com</a>";
										break;
									case 'mjimenez@mortonsubastas.com':
										echo "En caso de que usted no desee que sus lotes sean recontratados o ya no califiquen para participar en subastas futuras, le sugerimos ponerse en contacto con Miriam Jiménez al <a href='tel:+525552833140' style='font-weight: bold; color: #004d43; text-decoration: none'> 55 52 83 31 40</a> ext. 5093 o vía correo electrónico a <a href='mailto:mjimenez@mortonsubastas.com' style='font-weight: bold; color: #004d43; text-decoration: none'>mjimenez@mortonsubastas.com</a>.para darle a conocer la ubicación exacta de sus piezas.";
										break;
								}

								//echo " Horario de atención es de lunes a viernes de 9:30 am a 6:00 pm.</p><br><br>";
								// LOTES NO VENDIDOS (AM Y OG) ----------------------------------------------------------------
								$body .= "</table><br><br>
													<p style='text-align:justify'><strong>LOTES NO VENDIDOS</strong></strong><br>";
								//$body .= "Algunos lotes podrán recontratarse para próximas subastas. Favor de esperar el correo electrónico en el cual le haremos saber.<br><br>";
								$leyenda_no_vendidos = "NO";
								...
								switch ($fac) {
									case 'ebonilla@mortonsubastas.com':
										if (strpos($nom_sub, "Arte Moderno") > 0 || strpos($nom_sub, "arte moderno") > 0 || strpos($nom_sub, "Arte Mexicano") > 0) {
											...
											// 				Usted cuenta con 4 días hábiles posteriores a la subasta para recoger su(s) lote(s) en nuestra sucursal de Cerro de Mayka # 115, Lomas de Chapultepec, el 5to día no hay entrega, los lotes serán trasladados a nuestra bodega ubicada en Av. Constituyentes #910, Lomas Altas y los podrá recoger a partir del 6to día, en un horario de lunes a viernes de 9:30 am a 6:00 pm. De no recogerlos dentro de este plazo, Morton Subastas podrá reprogramar su venta automáticamente en otra subasta ajustando el precio a nuestra consideración de acuerdo al contrato de consignación que usted firmó.<br>
											// 				";
											// $body .= "En caso de que usted no desee que sus lotes sean recontratados o ya no califiquen para participar en subastas futuras, le sugerimos ponerse en contacto con Fernanda Serrano  al <a href='tel:+525552833140' style='font-weight: bold; color: #004d43; text-decoration: none'>55 52 83 31 40</a> ext. 6894 o vía correo electrónico a <a href='mailto:mserrano@mortonsubastas.com' style='font-weight: bold; color: #004d43; text-decoration: none'>mserrano@mortonsubastas.com</a> ";
											// $body .= "o con Ana Paula López al <a href='tel:+525552833140' style='font-weight: bold; color: #004d43; text-decoration: none'>55 52 83 31 40 </a>ext. 3384 o vía correo electrónico a <a href='mailto:aplopez@mortonsubastas.com' style='font-weight: bold; color: #004d43; text-decoration: none'>aplopez@mortonsubastas.com</a>.";
										} else {
											$body .= "
															<b>NOTA IMPORTANTE:</b><br>
															Usted cuenta con 4 días hábiles posteriores a la subasta para recoger su(s) lote(s) en nuestra sucursal de Cerro de Mayka # 115, Lomas de Chapultepec, el 5to día no hay entrega, los lotes serán trasladados a nuestra bodega ubicada en Av. Constituyentes #910, Lomas Altas y los podrá recoger a partir del 6to día, en un horario de lunes a viernes de 9:30 am a 6:00 pm. De no recogerlos dentro de este plazo, Morton Subastas podrá reprogramar su venta automáticamente en otra subasta ajustando el precio a nuestra consideración de acuerdo al contrato de consignación que usted firmó.<br>
															";
											$body .=  "En caso de que usted desee que sus lotes sean recontratados, le sugerimos ponerse en contacto
															con Diana Álvarez al <a href='tel:+525552833140' style='font-weight: bold; color: #004d43; text-decoration: none'>55 52 83 31 40</a> ext. 3145 o vía correo electrónico
															a <a href='mailto:dalvarez@mortonsubastas.com' style='font-weight: bold; color: #004d43; text-decoration: none'>dalvarez@mortonsubastas.com</a>.
															<br><br>
															";
									...
									case 'jjuarez@mortonsubastas.com':
										if (
											strpos($nom_sub, "Antigüedades") > 0 ||
											strpos($nom_sub, "antigüedades") > 0
										) {
											$body .= "Algunos lotes podrán recontratarse para próximas subastas. Favor de esperar el correo electrónico en el cual le haremos saber.";
											//$body .= "En caso de que usted no desee que sus lotes sean recontratados o ya no califiquen para participar en subastas futuras, le sugerimos ponerse en contacto con Verónica Bernal al <a href='tel:+525552833140' style='font-weight: bold; color: #004d43; text-decoration: none'> 55 52 83 31 40</a> ext. 6883 o vía correo electrónico a ";
											//$body .= "<a href='mailto:vbernal@mortonsubastas.com' style='font-weight: bold; color: #004d43; text-decoration: none'>vbernal@mortonsubastas.com</a>";
										}
										if (strpos($nom_sub, "Joyeria") > 0) {
											$body .= "En caso de que usted no desee que sus lotes sean recontratados o ya no califiquen para participar en subastas futuras, le sugerimos ponerse en contacto con Alejandra Rojas al <a href='tel:+525552833140' style='font-weight: bold; color: #004d43; text-decoration: none'> 55 52 83 31 40</a> ext. 6895 o vía correo electrónico a ";
											$body .= "<a href='mailto:arojas@mortonsubastas.com' style='font-weight: bold; color: #004d43; text-decoration: none'>arojas@mortonsubastas.com</a>";
										}
										break;
									case 'cpascual@mortonsubastas.com':
										if (strpos($nom_sub, "Vinos") > 0) {

											$body .= "Algunos lotes podrán recontratarse para próximas subastas. Favor de esperar el correo electrónico en el cual le haremos
                    saber.";

											/* $body .= "En caso de que usted no desee que sus lotes sean recontratados o ya no califiquen para participar en subastas futuras, le sugerimos ponerse en contacto con Jessica Cazarez al <a href='tel:+525552833140' style='font-weight: bold; color: #004d43; text-decoration: none'> 55 52 83 31 40</a> ext. 3130 o vía correo electrónico a ";
											$body .= "<a href='mailto:jcazares@mortonsubastas.com' style='font-weight: bold; color: #004d43; text-decoration: none'>jcazares@mortonsubastas.com</a>"; */
										} else {
											if ((strpos($nom_sub, "Joyeria") > 0) || (strpos($nom_sub, "Joyería") > 0)) {
											} else {
												$body .= "En caso de que usted no desee que sus lotes sean recontratados o ya no califiquen para participar en subastas futuras, le sugerimos ponerse en contacto con Jaciel López al <a href='tel:+525552833140' style='font-weight: bold; color: #004d43; text-decoration: none'> 55 52 83 31 40</a> ext. 5120 o vía correo electrónico a ";
												$body .= "<a href='mailto:jlopez@mortonsubastas.com' style='font-weight: bold; color: #004d43; text-decoration: none'>jlopez@mortonsubastas.com</a>";
											}
										}
										break;
									case 'mjimenez@mortonsubastas.com':
										$body .= "En caso de que usted no desee que sus lotes sean recontratados o ya no califiquen para participar en subastas futuras, le sugerimos ponerse en contacto con Miriam Jiménez al <a href='tel:+525552833140' style='font-weight: bold; color: #004d43; text-decoration: none'> 55 52 83 31 40</a> ext. 5093 o vía correo electrónico a ";
										$body .= "<a href='mailto:mjimenez@mortonsubastas.com' style='font-weight: bold; color: #004d43; text-decoration: none'>mjimenez@mortonsubastas.com</a> para darle a conocer la ubicación exacta de sus piezas.";
										break;
								}

								//$body .= " Horario de atención es de lunes a viernes de 9:30 am a 6:00 pm.</p><br><br>";
							}
							...
							if ($bandera == 1) {
								...
								if (($untexto == 0) && (trim($variable2[$j]["price"]) > 0)) {
									...
									// LOTES VENDIDOS (AM Y OG) ----------------------------------------------------------------
									switch ($fac) {
										case 'ebonilla@mortonsubastas.com':
											if ((strpos($nom_sub, "Arte Moderno") > 0) || (strpos($nom_sub, "arte moderno") > 0) || (strpos($nom_sub, "Arte Mexicano") > 0)) {
												echo "<br><br><p style='text-align:justify'><strong>LOTES VENDIDOS</strong></strong></p><br>";
												echo "<li style='text-align:justify'>El pago será programado a partir del cuarto miércoles posterior a la fecha en que se realizó la subasta, por medio de transferencia bancaria (siempre y cuando el comprador haya liquidado la compra). Si tiene alguna duda por favor de comunicarse con Sonia López al <a href='tel:5552833140' style='font-weight: bold; color: #004d43; text-decoration: none'>55 52 83 31 40 ext. 3396</a> o vía correo electrónico a <a href='mailto:slopez@mortonsubastas.com' style='font-weight: bold; color: #004d43; text-decoration: none'>slopez@mortonsubastas.com</a></li>";

												echo "<li style='text-align:justify'>Si solicitó comprobante de la retención de impuestos (ISR), favor de ponerse en contacto con Ana Laura Morales al teléfono, <a href='tel:5552833140' style='font-weight: bold; color: #004d43; text-decoration: none'>55 52 83 31 40 ext. 3395</a> o vía correo electrónico a <a href='mailto:amorales@mortonsubastas.com' style='font-weight: bold; color: #004d43; text-decoration: none'>amorales@mortonsubastas.com</a></li>";

												echo "<li style='text-align:justify'>Si solicitó factura, favor de ponerse en contacto vía correo electrónico a <a href='mailto:facturacion@mortonsubastas.com' style='font-weight: bold; color: #004d43; text-decoration: none'>facturacion@mortonsubastas.com</a></li>";

												// echo "<li style='text-align:justify'>Si tiene alguna duda le sugerimos ponerse en contacto con Fernanda Serrano al <a href='tel:5552833140' style='font-weight: bold; color: #004d43; text-decoration: none'>55 52 83 31 40 ext. 6894</a> o vía correo electrónico a <a href='mailto:mserrano@mortonsubastas.com' style='font-weight: bold; color: #004d43; text-decoration: none'>mserrano@mortonsubastas.com</a> o con Ana Paula López al <a href='tel:5552833140' style='font-weight: bold; color: #004d43; text-decoration: none'>55 52 83 31 40 ext. 3384</a> o vía correo electrónico a <a href='mailto:aplopez@mortonsubastas.com' style='font-weight: bold; color: #004d43; text-decoration: none'>aplopez@mortonsubastas.com</a></li>";
												echo "</ul><br><br>";
											} else {
												echo "<br><br><p style='text-align:justify'><strong>LOTES VENDIDOS</strong></strong></p><br>";
												echo "<ul><li><p style='text-align:justify'>El pago será programado a partir del cuarto miércoles posterior a la fecha en que se realizó la subasta, por medio de transferencia bancaria (siempre y cuando el comprador haya liquidado la compra). Si tiene alguna duda por favor de comunicarse con Sonia López al 55 52 83 31 40 ext. 3396 o vía correo electrónico a <a href='mailto:slopez@mortonsubastas.com' style='font-weight: bold; color: #004d43; text-decoration: none'>slopez@mortonsubastas.com</a></p></li>";
												...
												echo "<li><p style='text-align:justify'> Si solicitó factura, favor de ponerse en contacto vía correo electrónico a <a href='facturacion@mortonsubastas.com' style='font-weight: bold; color: #004d43; text-decoration: none'>facturacion@mortonsubastas.com</a></p></li>
																		...
																		<li><p style='text-align:justify'> Si tiene alguna duda le sugerimos ponerse en contacto con Diana Álvarez al 55 52 83 31 40 o vía correo electrónico a  <a href='dalvarez@mortonsubastas.com' style='font-weight: bold; color: #004d43; text-decoration: none'>dalvarez@mortonsubastas.com</a></p></li>
																	</ul>
																	<br>
																	<br>";
											}
										...
										case 'jjuarez@mortonsubastas.com':
											echo  "<br><br><p style='text-align:justify'><strong>LOTES VENDIDOS</strong></strong></p><br>
																		<ul>";
											if (strpos($nom_sub, "Antigüedades") > 0 || strpos($nom_sub, "antigüedades") > 0) {
												echo "<li><p style='text-align:justify'>El pago será programado a partir del cuarto miércoles posterior a la fecha en que se realizó la subasta, por medio de transferencia  bancaria (siempre y cuando el comprador haya liquidado la compra).Si tiene alguna duda por favor de comunicarse con Sonia López al <a href='tel:55 5283 3140' style='font-weight: bold; color: #004d43; text-decoration: none'>55 52 83 31 40 ext. 3396</a> o vía correo electrónico a <a href='slopez@mortonsubastas.com' style='font-weight: bold; color: #004d43; text-decoration: none'>slopez@mortonsubastas.com</a><br></p></li>";

												echo "<li><p style='text-align:justify'> Si solicitó comprobante de la retención de impuestos (ISR), favor de ponerse en contacto con Ana Laura Morales al teléfono, <a href='tel:55 5283 3140' style='font-weight: bold; color: #004d43; text-decoration: none'>55 52 83 31 40ext. 3395</a>  o vía correo electrónico a 	<a href='mailto:amorales@mortonsubastas.com' style='font-weight: bold; color: #004d43; text-decoration: none'>amorales@mortonsubastas.com</a><br></p></li>
											...
											if (strpos($nom_sub, "Joyería") > 0 || strpos($nom_sub, "joyería") > 0 || strpos($nom_sub, "Relojería") > 0) {
										...
										case 'cpascual@mortonsubastas.com':
											if ((strpos($nom_sub, "Joyeria") > 0) || (strpos($nom_sub, "Joyería") > 0)) {
												...
												echo "<br><br>
																		<p style='text-align:justify'><strong>LOTES VENDIDOS</strong></strong></p><br>
																		<ul>
																			<li><p style='text-align:justify'> El pago será programado a partir del cuarto lunes posterior a la fecha en que se realizó la subasta, por medio de transferencia  bancaria (siempre y cuando el comprador haya liquidado la compra).Si tiene alguna duda por favor de comunicarse con Sonia López al 55 52 83 31 40 ext. 3396 o vía correo electrónico a <a href='jlopez@mortonsubastas.com' style='font-weight: bold; color: #004d43; text-decoration: none'>slopez@mortonsubastas.com</a><br></p></li>";
										...
										case 'mjimenez@mortonsubastas.com':
											echo "<br><br>
																		<p style='text-align:justify'><strong>LOTES VENDIDOS</strong></strong></p><br>
																		<ul>
																			<li><p style='text-align:justify'> El pago será programado a partir del segundo lunes posterior a la fecha en que se realizó la subasta, por medio de transferencia  bancaria (siempre y cuando el comprador haya liquidado la compra).<br></p></li>";
									...
									switch ($fac) {
										case 'ebonilla@mortonsubastas.com':
											if ((strpos($nom_sub, "Arte Moderno") > 0) || (strpos($nom_sub, "arte moderno") > 0) || (strpos($nom_sub, "Arte Mexicano") > 0)) {
												$body .= "<br><br><p style='text-align:justify'><strong>LOTES VENDIDOS</strong></strong></p><br>";
												$body .= "<li style='text-align:justify'>El pago será programado a partir del cuarto miércoles posterior a la fecha en que se realizó la subasta, por medio de transferencia bancaria (siempre y cuando el comprador haya liquidado la compra). Si tiene alguna duda por favor de comunicarse con Sonia López al <a href='tel:5552833140' style='font-weight: bold; color: #004d43; text-decoration: none'>55 52 83 31 40 ext. 3396</a> o vía correo electrónico a <a href='mailto:slopez@mortonsubastas.com' style='font-weight: bold; color: #004d43; text-decoration: none'>slopez@mortonsubastas.com</a></li>";

												$body .= "<li style='text-align:justify'>Si solicitó comprobante de la retención de impuestos (ISR), favor de ponerse en contacto con Ana Laura Morales al teléfono, <a href='tel:5552833140' style='font-weight: bold; color: #004d43; text-decoration: none'>55 52 83 31 40 ext. 3395</a> o vía correo electrónico a <a href='mailto:amorales@mortonsubastas.com' style='font-weight: bold; color: #004d43; text-decoration: none'>amorales@mortonsubastas.com</a></li>";

												$body .= "<li style='text-align:justify'>Si solicitó factura, favor de ponerse en contacto vía correo electrónico a <a href='mailto:facturacion@mortonsubastas.com' style='font-weight: bold; color: #004d43; text-decoration: none'>facturacion@mortonsubastas.com</a></li>";

												// $body .= "<li style='text-align:justify'>Si tiene alguna duda le sugerimos ponerse en contacto con Fernanda Serrano al <a href='tel:5552833140' style='font-weight: bold; color: #004d43; text-decoration: none'>55 52 83 31 40 ext. 6894</a> o vía correo electrónico a <a href='mailto:mserrano@mortonsubastas.com' style='font-weight: bold; color: #004d43; text-decoration: none'>mserrano@mortonsubastas.com</a> o con Ana Paula López al <a href='tel:5552833140' style='font-weight: bold; color: #004d43; text-decoration: none'>55 52 83 31 40 ext. 3384</a> o vía correo electrónico a <a href='mailto:aplopez@mortonsubastas.com' style='font-weight: bold; color: #004d43; text-decoration: none'>aplopez@mortonsubastas.com</a></li>";
												$body .= "</ul><br><br>";
											} else {
												$body .= "<br><br><p style='text-align:justify'><strong>LOTES VENDIDOS</strong></strong></p><br>";
												$body .= "<ul><li><p style='text-align:justify'>El pago será programado a partir del cuarto miércoles posterior a la fecha en que se realizó la subasta, por medio de transferencia bancaria (siempre y cuando el comprador haya liquidado la compra). Si tiene alguna duda por favor de comunicarse con Sonia López al 55 52 83 31 40 ext. 3396 o vía correo electrónico a <a href='mailto:slopez@mortonsubastas.com' style='font-weight: bold; color: #004d43; text-decoration: none'>slopez@mortonsubastas.com</a></p></li>";
												$body .= "<li><p style='text-align:justify'>Si solicitó comprobante de la retención de impuestos (ISR), favor de ponerse en contacto con Ana Laura Morales al teléfono, 55 52 83 31 40 ext. 3395 o vía correo electrónico a <a href='mailto:retencionisr@mortonsubastas.com' style='font-weight: bold; color: #004d43; text-decoration: none'>retencionisr@mortonsubastas.com</a></p></li>";
											}
										...
										case 'jjuarez@mortonsubastas.com':
											if ((strpos($nom_sub, "antigüedades") > 0) || (strpos($nom_sub, "Antigüedades") > 0)) {
												...
												$body .= "
																				<li>
																				<p style='text-align:justify'> Si solicitó factura, favor de ponerse en contacto vía correo electrónico a <a href='facturacion@mortonsubastas.com' style='font-weight: bold; color: #004d43; text-decoration: none'>facturacion@mortonsubastas.com</a></p>
																				</li>
																				";
											} elseif ((strpos($nom_sub, "Joyería") > 0) || (strpos($nom_sub, "joyería") > 0) || (strpos($nom_sub, "Relojería") > 0)) {
												$body .= "<br><br><p style='text-align:justify'><strong>LOTES VENDIDOS</strong></strong></p><br>";
										...
										case 'cpascual@mortonsubastas.com':
											if ((strpos($nom_sub, "Joyeria") > 0) || (strpos($nom_sub, "Joyería") > 0)) {
												$body .= "<br><br>
																					<p style='text-align:justify'><strong>LOTES VENDIDOS</strong></strong></p><br>
																					<ul>";
												$body .= "<li><p style='text-align:justify'> El pago será programado a partir del cuarto miercoles posterior a la fecha en que se realizó la subasta, por medio de transferencia  bancaria (siempre y cuando el comprador haya liquidado la compra).Si tiene alguna duda por favor de comunicarse con Sonia López ";
												$body .= "al 55 52 83 31 40 ext. 3396 o vía correo electrónico a <a href='slopez@mortonsubastas.com' style='font-weight: bold; color: #004d43; text-decoration: none'>slopez@mortonsubastas.com</a><br></p></li>";
												$body .=  "<li><p style='text-align:justify'> Si solicitó comprobante de la retención de impuestos (ISR), favor de ponerse en contacto con Ana Laura Morales al teléfono, <a href='tel:55 5283 3140' style='font-weight: bold; color: #004d43; text-decoration: none'>55 52 83 31 40</a> ext. 3395 o vía correo electrónico ";
												$body .=  "a <a href='retencionisr@mortonsubastas.com' style='font-weight: bold; color: #004d43; text-decoration: none'>retencionisr@mortonsubastas.com</a><br></p></li>";
												$body .=  "</ul><br><br>";
											} else {
												$body .= "<br><br>
																				<p style='text-align:justify'><strong>LOTES VENDIDOS</strong></strong></p><br>
									...
									// <li><p style='text-align:justify'> Si solicitó factura, favor de ponerse en contacto vía correo electrónico a <a href='mailto:facturacion@mortonsubastas.com' style='font-weight: bold; color: #004d43; text-decoration: none'>facturacion@mortonsubastas.com</a></p></li>
									$body .= "
					...
					if (($solo_vendidos == "SI") and (($fac == 'jjuarez@mortonsubastas.com') or ($fac == 'cpascual@mortonsubastas.com'))) {
						...
						if ($fac == 'jjuarez@mortonsubastas.com') {
							if ((strpos($nom_sub, "antigüedades") > 0) || (strpos($nom_sub, "Antigüedades") > 0)) {
								// echo "entra";
							} else if ((strpos($nom_sub, "Relojería") > 0)) {
								echo "Si tiene alguna duda le sugerimos ponerse en contacto con Alejandra Rojas al <a href='tel:55 5283 3140' style='font-weight: bold; color: #004d43; text-decoration: none'>55 52 83 31 40 ext. 6895</a> o vía correo electrónico a <a href='arojas@mortonsubastas.com' style='font-weight: bold; color: #004d43; text-decoration: none'>arojas@mortonsubastas.com</a><br><br>";
								$body .=  "Si tiene alguna duda le sugerimos ponerse en contacto con Alejandra Rojas al <a href='tel:55 5283 3140' style='font-weight: bold; color: #004d43; text-decoration: none'>55 52 83 31 40 ext. 6895</a> o vía correo electrónico a <a href='arojas@mortonsubastas.com' style='font-weight: bold; color: #004d43; text-decoration: none'>arojas@mortonsubastas.com</a><br><br>";
							}
						} elseif ($fac == 'cpascual@mortonsubastas.com') {
							if ((strpos($nom_sub, "Vinos") > 0)) {
								...
								echo "entra- Si tiene alguna duda le sugerimos ponerse en contacto con Jaciel López al <a href='tel:5552833140' style='font-weight: bold; color: #004d43; text-decoration: none'>55 52 83 31 40 ext. 5120</a> o vía correo electrónico a <a href='mailto:jlopez@mortonsubastas.com' style='font-weight: bold; color: #004d43; text-decoration: none'>jlopez@mortonsubastas.com</a><br><br>";
								$body .=  "Si tiene alguna duda le sugerimos ponerse en contacto con Jaciel López al <a href='tel:55 5283 3140' style='font-weight: bold; color: #004d43; text-decoration: none'>55 52 83 31 40 ext. 5120</a> o vía correo electrónico a <a href='mailto:jlopez@mortonsubastas.com' style='font-weight: bold; color: #004d43; text-decoration: none'>jlopez@mortonsubastas.com</a><br><br>";
							}
						} else {
                  ...
                  al <a href='tel:5552833140' style='font-weight: bold; color: #004d43; text-decoration: none'>55 52 83 31 40 ext. 5126</a> o vía correo electrónico a <a href='mailto:dbaez@mortonsubastas.com' style='font-weight: bold; color: #004d43; text-decoration: none'>dbaez@mortonsubastas.com</a>, o con Sofía Hernández al <a href='tel:5552833140' style='font-weight: bold; color: #004d43; text-decoration: none'>55 52 83 31 40 ext. 4103</a> o vía correo electrónico a <a href='mailto:rhernandez@mortonsubastas.com' style='font-weight: bold; color: #004d43; text-decoration: none'>rhernandez@mortonsubastas.com</a>, Usted cuenta con 4 días hábiles
                  ...
                  consideración de acuerdo al contrato de consignación que usted firmó.
								...
								echo "vía correo electrónico a <a href='mailto:arojas@mortonsubastas.com' style='font-weight: bold; color: #004d43; text-decoration: none'>arojas@mortonsubastas.com</a>.</p><br>";

								$body .= "<p style='text-align:justify'>Usted cuenta con 5 días hábiles posteriores a la subasta para recoger su(s) lote(s) en nuestra sucursal de Monte Athos #179, Lomas de Chapultepec. ";
								$body .= "De no recogerlos dentro de este plazo, Morton Subastas podrá reprogramar su venta automáticamente en otra subasta ajustando el precio a nuestra consideración de acuerdo al contrato de consignación que usted firmó.<br><br>";
								$body .= "En caso de que usted desee que sus lotes sean recontratados, le sugerimos ponerse en contacto con Alejandra Rojas al <a href='tel:55 5283 3140' style='font-weight: bold; color: #004d43; text-decoration: none'>55 52 83 31 40 ext. 6895 </a>o ";
								$body .= "vía correo electrónico a <a href='mailto:arojas@mortonsubastas.com' style='font-weight: bold; color: #004d43; text-decoration: none'>arojas@mortonsubastas.com</a>.</p><br>";
							} else {
								...
								$body .= "<p style='text-align:justify'>Usted cuenta con 4 días hábiles posteriores a la subasta para recoger su(s) lote(s) en nuestra sucursal de Monte Athos #179, Lomas de Chapultepec, el 5to día no hay entrega, los lotes serán trasladados a nuestra bodega ubicada en Av. Constituyentes #910, Lomas Altas y los podrá recoger a partir del 6to día, en un horario de lunes a viernes de 9:30 am a 6:00 pm. ";
								echo "De no recogerlos dentro de este plazo, Morton Subastas podrá reprogramar su venta automáticamente en otra subasta ajustando el precio a nuestra consideración de acuerdo al contrato de consignación que usted firmó.<br><br>";
								$body .=  "De no recogerlos dentro de este plazo, Morton Subastas podrá reprogramar su venta automáticamente en otra subasta ajustando el precio a nuestra consideración de acuerdo al contrato de consignación que usted firmó.<br><br>";
								...
								$body .= "En caso de que usted desee que sus lotes sean recontratados, le sugerimos ponerse en contacto con Verónica Bernal al <a href='tel:55 5283 3140' style='font-weight: bold; color: #004d43; text-decoration: none'>55 52 83 31 40 ext. 6883 </a>o ";
								...
								$body .=  "vía correo electrónico a <a href='vbernal@mortonsubastas.com' style='font-weight: bold; color: #004d43; text-decoration: none'>vbernal@mortonsubastas.com</a>.</p><br>";
							}
						}
						...
						if ($fac == 'ebonilla@mortonsubastas.com') {
			              ...
			              <p style ='text-align:justify'>
			                ...
			                <br>
								...
								echo "vía correo electrónico a <a href='dalvarez@mortonsubastas.com' style='font-weight: bold; color: #004d43; text-decoration: none'>dalvarez@mortonsubastas.com</a>.</p><br>";
							}
						}
						...
						if ($fac == 'cpascual@mortonsubastas.com') {
							if ((strpos($nom_sub, "Joyeria") > 0) || (strpos($nom_sub, "Joyería") > 0)) {
								...
								$body .= "De no recogerlos dentro de este plazo, Morton Subastas podrá reprogramar su venta automáticamente en otra subasta ajustando el precio a nuestra consideración de acuerdo al contrato de consignación que usted firmó.<br><br>";
								$body .= "En caso de que usted desee que sus lotes sean recontratados, le sugerimos ponerse en contacto con Alejandra Rojas al <a href='tel:55 5283 3140' style='font-weight: bold; color: #004d43; text-decoration: none'>55 52 83 31 40 ext. 6895 </a>o ";
								$body .= "vía correo electrónico a <a href='arojas@mortonsubastas.com' style='font-weight: bold; color: #004d43; text-decoration: none'>arojas@mortonsubastas.com</a>.</p><br>";
							} else if ((strpos($nom_sub, "Vinos") > 0) || (strpos($nom_sub, "vinos") > 0)) {
				  ...
				  otra subasta ajustando el precio a nuestra consideración de acuerdo al contrato de consignación que usted firmó.
								...
								echo "De no recogerlos dentro de este plazo, Morton Subastas podrá reprogramar su venta automáticamente en otra subasta ajustando el precio a nuestra consideración de acuerdo al contrato de consignación que usted firmó.<br><br>";
								$body .=  "De no recogerlos dentro de este plazo, Morton Subastas podrá reprogramar su venta automáticamente en otra subasta ajustando el precio a nuestra consideración de acuerdo al contrato de consignación que usted firmó.<br><br>";
								echo "En caso de que usted desee que sus lotes sean recontratados, le sugerimos ponerse en contacto con Jaciel Lopez al <a href='tel:55 5283 3140' style='font-weight: bold; color: #004d43; text-decoration: none'>55 52 83 31 40 ext. 5120 </a>o ";
								$body .= "En caso de que usted desee que sus lotes sean recontratados, le sugerimos ponerse en contacto con Jaciel López al <a href='tel:55 5283 3140' style='font-weight: bold; color: #004d43; text-decoration: none'>55 52 83 31 40 ext. 5120 </a>o ";
								...
								$body .=  "vía correo electrónico a <a href='jlopez@mortonsubastas.com' style='font-weight: bold; color: #004d43; text-decoration: none'>jlopez@mortonsubastas.com</a>.</p><br>";
							}
						}
						echo "<ul><b>¿NECESITA ENVIAR A UN REPRESENTANTE POR LA DEVOLUCIÓN?</b><br><br>";
						$body .= "<ul><b>¿NECESITA ENVIAR A UN REPRESENTANTE POR LA DEVOLUCIÓN?</b><br><br>";
						...
						$body .= "<li>Carta poder por medio de la cual el consignante o comprador autorice a un tercero a recoger los lotes. En dicha carta se deberán identificar los lotes que estamos entregando (si desea le podemos enviar un machote de la misma).</li>";
						...
						if ($pagado == 1) {
							...
							$body .= "<ul><b>SI TIENE ALGÚN ADEUDO LAS FORMAS DE PAGO SON LAS SIGUIENTES:</b></ul>";
							echo "1) En efectivo (monto máximo $308,866.20 MN) - directamente en nuestras cajas.<br>";
							$body .= "1) En efectivo (monto máximo $308,866.20 MN) - directamente en nuestras cajas.<br>";
							echo "2) Cheque - salvo buen cobro a nombre de Morton Subasta S.A. de C.V.<br>";
							$body .= "2) Cheque - salvo buen cobro a nombre de Morton Subasta S.A. de C.V.<br>";
							...
							$body .= "3) Paypal - Usar como referencia el correo <a href='mailto:creditoycobranza@mortonsubastas.com' style='font-weight: bold; color: #004d43; text-decoration: none'>creditoycobranza@mortonsubastas.com</a> para generar link de pago.<br>";
							echo "4) Tarjeta de crédito y débito - con cargo del 6.6% por uso de tarjeta, directamente en nuestras cajas.<br>";
							$body .= "4) Tarjeta de crédito y débito - con cargo del 6.6% por uso de tarjeta, directamente en nuestras cajas.<br>";
							echo "5) Transferencia bancaria o depósito en ventanilla o practicaja:<br>";
							$body .= "5) Transferencia bancaria o depósito en ventanilla o practicaja:<br>";
							echo "</ul>";
							$body .= "</ul>";
							echo "<br>";
							$body .= "<br>";
							echo   "<b>BBVA Bancomer<br>
											...
											Clabe 0121 8000 1038 0703 75<br>
											Una vez realizado el pago, favor de enviar comprobante de pago a:<br>
											<a href='mailto:creditoycobranza@mortonsubastas.com' style='font-weight: bold; color: #004d43; text-decoration: none'>creditoycobranza@mortonsubastas.com </a><br>";
							$body .=  "<b>BBVA Bancomer<br>
													Morton Subastas, S.A. de C.V.</b><br>
													Cuenta 0103807037<br>
													Clabe 0121 8000 1038 0703 75<br>
													Una vez realizado el pago, favor de enviar comprobante de pago a:<br>
					...
					if ($llega_de == 'prueba') {
						if (($fac == "cpascual@mortonsubastas.com") or ($fac == "jjuarez@mortonsubastas.com") or ($fac == "ebonilla@mortonsubastas.com")) {
							...
							echo 'SI_Correo electrónico se envio correctamente';
							//unset($mail);
							$mail->ClearAddresses();
						} else {
							echo "<h1><b>1NO SE ENVIA NADA-sin send</b></h1>";
						}
					} else {
						$mail->send();                                                        //When I want to send a email
						echo '1Correo electrónico se envio correctamente';
						//unset($mail);
						$mail->ClearAddresses();
					}
				}

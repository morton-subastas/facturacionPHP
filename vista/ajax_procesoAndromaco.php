...
$conn = new mysqli("localhost", "root", "", "timbrado");
  ...
  if ($conn->connect_error) {
    ...
    if ($trae == 0){
      ...
      VALUES ('".$SUB_R."','".$CON_R."','".$PAR_R."','".$PAL_R."','0.00','".$EMA_R."','', 'DEVOLVER','Andrómaco','".$fac."');";
      //echo $query;
      //$resultado = $query;
      ...
      //$resultado = "UPDATE";
      $query = "UPDATE `emailenviados` SET `lugar30` =  'Andrómaco' WHERE `contrato` = '".$CON_R."' AND `paleta` ='".$PAL_R."';";
      //echo $query;
      //$resultado = $query;
      $result = $conn->query($query);

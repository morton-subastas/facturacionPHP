              ...
              <fieldset>
                <nav aria-label="breadcrumb">
                  <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Método Pago</li>
                  </ol>
                </nav>
              </fieldset>
                <form class="form-horizontal" method="post">
                    <fieldset>
                        <legend class="text-center header"><h1><strong style="color:#004D43 !important">Catálogo S.A.T.</strong> - <strong>Método Pago</strong></h1></legend>
                        <br>
                        <br>
                        <div class="box-body">
                        <table id="table" class="table table-bordered table-hover table-striped dt-responsive tabla-fac">
                            ...
                            <tbody>
                                ...
                                foreach ($c_MetodoPago as $key => $value){
                                    echo "<tr>";
                                        echo "<td>".$value['metodopago_clave']."</td>";
                                        echo "<td>".$value['metodopago_descripcion']."</td>";

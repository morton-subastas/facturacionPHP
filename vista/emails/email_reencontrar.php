  ...
  require '../Phpmailer/SMTP.php';
    ...
    try {
        ...
        echo "<font face='Times, serif', size='5'>Estimad(@) ".$nombre."<br><br>";
        echo "Para dar seguimiento a sus lotes no vendidos, a continuación le envío un listado, en el que se incluye algunas observaciones que son importantes que revise con cuidado:<br><br>";

        echo "En caso de contactar con su autorización  para la recontratación de dichos lotes, programaremos la inclusión de los mismos en subastas próximas. En promedio, tendremos que esperar al menos cuatro semanas para que vuelvan a subastarse, le haremos saber en cuanto tengamos la fecha exacta.<br><br>";
				echo "En caso de preferir la devolución de los lotes, le pido contactar a nuestra responsable de atención a clientes, Mariana Ramírez,, al 55 5283 3140 ext. 4110 o vía correo electrónico a mramirez@mortonsubastas.com para que le informe sobre la ubicación de sus lotes.<br><br>";
				echo "Los horarios para devolución tanto en Cerro de Mayka #115 como en Av. Constituyentes # 910, son de lunes a viernes de 9:30 a.m. a 6:00 p.m.<br><br>";
				echo "Ver mapa<br>";
				echo "(Poner mapas)<br><br>";
				echo "Cerro de Mayka No. 115, Col. Lomas de Chapultepec, Ciudad de México<br>";
				echo "Av. Constituyentes No. 910, Col. Lomas Altas, Ciudad de México<br>";
  			echo "Monte Athos No. 179, Col. Lomas de Chapultepec, Ciudad de México<br><br>";

				echo "Si usted necesita que otra persona recoja sus piezas en su representación, le suplicamos que dicha persona presente la siguiente información:<br><br>";
				echo "<ul>";
					echo "<li>Carta poder por medio de la cual el consignante o comprador autorice a un tercero a recoger los lotes. En dicha carta se deberán identificar los lotes que estamos entregando.</li><br>";
					echo "<li>Copia de la identificación del consignante adjunta a la carta poder.</li><br>";
					echo "<li>Copia de la Identificación identificación de la persona autorizada para recoger los lotes.</li>";
				echo "</ul>	<br><br>";
        echo "Quedo atenta en caso de que tenga cualquier duda o comentario.<br><br>";

    ...
    try {
        ...
        echo "<p style='line-height: 1.6; font-size: 14px'>";
			  $nombre = $variable[$emp]["firstname"]." ".$variable[$emp]["lastname"];
				...
				$body .= "<font face='Helvetica', size='5'>".$nombre."<br>Presente<br><br><p style='text-align:justify'> Dando seguimiento a las obras no vendidas de su contrato $sub, desafortunadamente ";
        echo "<font face='Helvetica, serif', size='5'>".$nombre."<br>Presente<br><br><p style='text-align:justify'> Dando seguimiento a las obras no vendidas de su contrato $sub, desafortunadamente ";
				$body .= "no vemos una posible venta en una nueva subasta, por lo que le agradeceremos pase a la brevedad a recoger su(s) pieza(s) no vendida(s).</p><br><br>";
        echo "no vemos una posible venta en una nueva subasta, por lo que le agradeceremos pase a la brevedad a recoger su(s) pieza(s) no vendida(s).</p><br><br>";
        ...
        echo	"<th style='padding: 15px; border-right: 2px solid #fff; background: #004d43; color: #fff'><center>Descripción</center></th>";
				$body .=	"<th style='padding: 15px; border-right: 2px solid #fff; background: #004d43; color: #fff'><center>Subasta/Lote</center></th>";
        echo	"<th style='padding: 15px; border-right: 2px solid #fff; background: #004d43; color: #fff'><center>Subasta/Lote</center></th>";
      ...
      echo "<p style='text-align:justify'>Le sugerimos ponerse en contacto con la Srta. Marian Ramirez al 55 5283 3140 ext. 4110 o vía correo electrónico (mramirez@mortonsubastas.com) para darle a conocer la ";
      echo "ubicación exacta de sus piezas, ya que, por cuestiones internas de logística, podrían ser ubicadas en Av. Constituyentes 910 ";
      echo "Col. Lomas Altas o en Cerro Mayka. El horario de recolección es de lunes a viernes de 9:30 a.m. a 6:00 p.m.<br><br>";

      echo "Si usted no pudiera acudir personalmente, le agradecemos nos me envíe por este medio el nombre de la persona o los datos de la mudanza que estará autorizada ";
      echo "para este fin, ya que en las instalaciones se le solicitará los siguientes documentos:<br><br>";
			echo "<ul>";
			echo "<li>Carta poder por medio de la cual el consignante autorice a un tercero a recoger los lotes. En dicha carta se deberán identificar los lotes que estamos entregando.</li><br>";
			echo "<li>Copia de la identificación del consignante adjunta a la carta poder.</li><br>";
			echo "<li>Copia de identificación oficial de la persona autorizada para recoger lotes</li><br>";
			echo "</ul><br>";
      echo "Por último, se le recomienda traer material de empaque si considera que sus piezas así lo requieren, ya que Morton Subastas no cuenta con ese servicio.<br><br>";
			echo "Quedamos atentos en caso de que tenga cualquier duda o comentario</p><br><br>";

      $body .= "Saludos, coordiales<br><br>";
      echo "Saludos, coordiales<br><br>";

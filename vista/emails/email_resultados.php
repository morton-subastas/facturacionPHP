  ...
  require '../Phpmailer/SMTP.php';
    ...
    try {
        ...
        echo "<font face='Times, serif', size='5'>".$nombre." <br>Presente<br><br>Dándole seguimiento a su contrato, verá adjunto a ";
        echo "este correo un archivo con la información correspondiente a los resultados de venta obtenidos durante nuestra Subasta _____________ , que se ";
        echo "llevó a cabo el pasado Sábado _________ de 2022 (ver columna 'Precio-Martillo'). En el cuerpo del correo verá los pasos a seguir en caso de que ";
        echo "sus lotes se hayan vendido y qué hacer.<br><br>";

        echo "<b>LOTES NO VENDIDOS</b><br><br>";
        echo "Por favor considere lo siguiente:<br>";
				echo "<ul>";
					echo"<li> El pago podrá ser programado a partir del segundo lunes posterior a la fecha en la que se llevó a cabo la subasta (siempre y cuando el comprador haya liquidado la compra).</li><br>";
					echo "<li>Si solicitó comprobante de retención de impuestos (ISR), favor de ponerse en contacto con Sonia López al teléfono 55 5283 3140 ext. 3396 o vía correo electrónico a slopez@mortonsubastas.com</li><br>";
					echo "<li>También puede ingresar a 'Mi Morton' en www.mimorton.com, una plataforma creada especialmente para nuestros consignantes y compradores, en la que podrá conocer el estatus e historial de sus piezas y el precio total de venta o compra.</li><br>";
					echo "<li>Crear una cuenta en esta plataforma es muy fácil, sólo es necesario su nombre, correo electrónico y número de cliente (este número lo puede localizar en el archivo adjunto). Si requiere asesoría, puede comunicarse con nosotros al 55 5283 3140 y con gusto lo atenderemos</li>";
				echo "</ul><br><br>";
        echo "<b>LOTES VENDIDOS</b><br><br>";
        echo "Por favor considere lo siguiente:<br>";
				echo "<ul>";
					echo "<li>Algunos lotes no vendidos, podrán recontratarse para próximas subastas. Por favor comuníquese con ______ para revisar el status de sus piezas y ver la posibilidad de que sus piezas se puedan incluir en subastas futuras.</li><br>";
					echo "<li>En caso de que no desee que sus lotes sean recontratados, o ya no califiquen para participar en subastas futuras, cuenta con 5 días hábiles posteriores a la subasta para recogerlos (para así no generar cargos adicionales por almacenaje). En caso de no recogerlos dentro de este plazo, Morton Subastas podrá reprogramar su venta automáticamente en otra subasta ajustando el precio a nuestra consideración de acuerdo al contrato de consignación que usted firmó.</li><br>";
					echo "<li>Le sugerimos ponerse en contacto con Mariana Ramírez al 55 5283 3140 ext. 4110 o vía correo electrónico a (mramirez@mortonsubastas.com) para darle a conocer la ubicación exacta de sus piezas, ya que, por cuestiones internas de logística, podrían ser trasladadas a otra ubicación.</li><br>";
				echo "</ul><br><br>";
				echo "El horario de entrega de piezas es Lunes a Viernes de 9:30 a.m.-6:00 p.m.<br><br>";
        echo "Quedo a su disposición en caso de que tenga cualquier duda o comentario.<br><br>";
				echo "¡Le agradecemos su participación en nuestra subasta!<br>";

    ...
    try {
        ...
        echo "<p style='line-height: 1.6; font-size: 14px'>";
			  $nombre = $variable[$emp]["firstname"]." ".$variable[$emp]["lastname"];
				...
				$body .= "<font face='Times, serif', size='5'>Estimado(a) ".$nombre."<br><br> Dando seguimiento a su contrato número ".$con.", ";
        echo "<font face='Times, serif', size='5'>Estimad(a) ".$nombre."<br><br> Dando seguimiento a  su contrato número ".$con.", ";
        echo "me permito enviarle como archivo adjunto la relación de piezas que están programadas para nuestra proxima Subasta de Oportunidades número ".$sub." ";
        echo ", la cual se llevará a cabo el proximo __________.<br><br>";
      ...
      echo "Lo invitamos  a consultar el catálogo digital en nuestro sitio web www.mortonsubastas.com y a seguir la subasta de manera presencial, en nuestro salón ";
      echo "de subastas o en línea.<br><br>";

      echo "Usted recibirá los resultados de la subasta vía correo electrónico a partir del __________.<br><br>";

      echo "Si tiene alguna duda, con gusto lo atenderá la Srta. Mariana Rodriguez Ramírez en el teléfono  55 5283 3140 extensión 4110.<br><br>";
			echo "¡Le deseamos mucha suerte!.<br><br> ";

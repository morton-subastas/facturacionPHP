  ...
  require '../Phpmailer/SMTP.php';
    ...
    try {
        ...
        echo "<font face='Times, serif', size='5'>Estimad(@) ".$nombre." Dando seguimiento a su contrato _______, me permito enviarle como archivo adjunto ";
        echo "la relación de piezas que están programadas para nuestra nuestra próxima subasta de ________ número _______, la cual se llevará a cabo el ";
        echo "próximo ___ de 2022.<br><br> ";

        echo "Lo invitamos a consultar el catálogo digital en nuestro sitio web WWW.MORTONSUBASTAS.COM <http://WWW.MORTONSUBASTAS.COM> y a seguir la subasta ";
        echo "de manera presencial, en nuestro salón de subastas, o en línea. <br><br>";

        echo "Usted recibirá los resultados de la subasta vía correo electrónico a partir del _________.<br><br>";

        echo "Si tiene alguna duda, con gusto lo atenderá __________ en el teléfono 5552833140 extensión _______.<br><br>";

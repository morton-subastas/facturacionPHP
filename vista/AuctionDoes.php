        ...
        for ($j = 0; $j <= $cuantos2; $j++) {
          ...
          if (($corr == $corr2) and ($con1 == $con2)) {
            if ($estimado == 0) {
              ...
              $body .= "<font face='Helvetica, serif'>" . $nombre . "Presente:<br><p style='text-align:justify'>";
              echo  "<font face='Helvetica, serif'>" . $nombre . "<br>Presente:<br><p style='text-align:justify'> ";
              //echo "<p> Posición: ".$i."</p>";
              //echo "Dando seguimiento de la subasta $sub de fecha, le informamos los resultados sobre sus lotes y además en el cuerpo del correo verá los pasos a seguir:";
              echo "A continuación le informamos los resultados de la <b>$nom_subasta_es </b> No. <b>$sub</b>.";
              // echo "nuestra subasta No.<strong>".$sub."</strong>, que se llevó a cabo el pasado __________ (ver columna 'Precio-Martillo'). En el cuerpo del correo verá los pasos a seguir en ";
              // echo "caso de que sus lotes se hayan vendido y qué hacer en caso de que no se hayan vendido.<br>";
              $estimado = 1;
            }
            ...
            if ((trim($variable2[$j]["price"]) == 0) && ($unico == 0) && (trim($variable2[$j]["price"]) != '')) {
              ...
              // if ((($solo_vendidos = "SI")and($leyenda_no_vendidos = "SI")) and ( ($fac == 'jjuarez@mortonsubastas.com')or ($fac == 'cpascual@mortonsubastas.com' ) )) {
              //
              //   if(($fac == 'jjuarez@mortonsubastas.com') and (strpos($nom_subasta_es, "Joyería") > 0) ||(strpos($nom_subasta_es, "joyería") > 0)){
              //
              //   }
              //
              // }
